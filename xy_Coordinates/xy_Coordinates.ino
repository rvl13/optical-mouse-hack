// NOTE : Modified the default example supplied with OptiMouse
//        Library for ADNS-2610 
// -------------------------------------------------------------
...
// #include "PAN3101.h"
// #include "ADNS2051.h"
#include "ADNS2610.h"                     // we are using ADNS-2610
// #include "ADNS2620.h"
// #include "ADNS2083.h"
...
ADNS2610 Optical1 = ADNS2610(SCLK, SDIO);     // we are using the ADNS-2610
...
void setup()
{
  Serial.begin(115200);                   // a bit faster baudrate
